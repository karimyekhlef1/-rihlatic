...
import { hotel_details,search_hotel_endpoint , hotel_prebook} from '@/app/Constant/urls';
...
const hotelsService = {
    ...
    hotelPrebook: async (Data) => {
        try {
            const response = await apiService.post(hotel_prebook,Data);
            return response;
        } catch (error) {
            throw error;
        }
