...
import { getVolsReservationDetails } from "@/lib/store/api/vols/volsSlice";
...
export default function VolResevationTable() {
                ...
                <>
                  <TableRow key={reservation.id}>
                    ...
                    <TableCell className="font-medium text-wrap text-xs">
                      {/* {format("dd/mm/yyyy",reservation.created_at) }  */}
                    </TableCell>
                    <TableCell className="font-medium text-wrap text-xs">
                      {reservation.ref} 
                    </TableCell>
                    ...
                    <TableCell className="font-medium text-xs hidden sm:table-cell">
                      {reservation.segments[0][0].boardAirport  }
                    </TableCell>
                    <TableCell className="font-medium text-xs hidden sm:table-cell">
                      {/* {formatDate(reservation.departure?.return_date)} */}XX
                    </TableCell>
                    <TableCell className="font-medium text-xs hidden md:table-cell">
                          ...
                          <ul className="space-y-2">
                            {reservation.activities.map((activity) => (
                              <li key={activity.id} className="text-sm">
                                <span className="font-medium">
                                  {formatDate(activity.description)}:
                                </span>{" "}
